...
public abstract class MapObject {
	...
	//constructor
	public MapObject(TileMap tm, ResourceLoader res) {
		tileMap = tm;;
	...
	public boolean intersects(StaticObject o){
		Rectangle r1 = getRectangle();
		Rectangle r2 = o.getRectangle();
		return r1.intersects(r2);
	}
	...
	public void checkTileMapCollision(double dx, double dy){
		this.dx = dx;
		this.dy = dy;
		currCol = (int)x / tileSize;
		currRow = (int)y / tileSize;
